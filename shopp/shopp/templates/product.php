...
<?php if (shopp('product','found')): ?>
	...
	<?php
	/* This is where to add the contact form - 
	Author: Akin Motolola 
	This code overwrites when shopp plugin is updated, so it has to be re-included
	
	*/
	?>
	
	<form id="ask_seller" name="form1" method="post" action="product.php">
  <table width="166" border="0">
	<tr>
	  <td width="337"><strong>Ask about this Product:</strong></td>
	</tr>
	<tr>
	  <td><label>
	...
	<tr>
	  <td><label>
		<textarea name="message" id="message" cols="23" rows="4">Message:
		</textarea>
	  </label></td>
	</tr>
  </table>
